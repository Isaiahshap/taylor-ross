...
// Add the detailed blog content
const blogPostsContent = {
  'understanding-medical-malpractice-claims': {
    content: [
      {
        type: 'paragraph',
        content: 'Medical malpractice cases are among the most complex areas of personal injury law, requiring both legal expertise and deep medical knowledge. At Taylor & Ross, we\'ve successfully represented hundreds of patients who have suffered due to medical negligence.'
      },
      {
        type: 'heading',
        content: 'Key Elements of a Medical Malpractice Claim'
      },
      {
        type: 'list',
        items: [
  ...
  'truck-accident-settlements': {
    content: [
      {
        type: 'paragraph',
        content: 'The landscape of truck accident litigation continues to evolve, with new federal regulations and technological advances impacting how these cases are handled and settled.'
      },
      {
        type: 'heading',
        content: 'Impact of New Safety Technologies'
      },
      {
        type: 'list',
        items: [
  ...
  'workplace-safety-post-covid': {
    content: [
      {
        type: 'paragraph',
        content: 'The COVID-19 pandemic has fundamentally changed how we approach workplace safety, introducing new legal obligations and considerations for both employers and employees.'
      },
      {
        type: 'heading',
        content: 'Emerging Workplace Safety Standards'
      },
      {
        type: 'list',
        items: [
          ...
          'Hybrid workplace safety protocols'
        ]
      },
      {
        type: 'statistic',
        label: 'Workplace Safety Claims',
        value: '+45%'
      }
    ]
  }
